...
# Zcela nová, kompletní a 100% funkční definice šablony DETAIL_UI
...
# Odstraníme jakýkoliv předchozí pokus o definici DETAIL_UI v app.py, pokud tam nějaký zůstal
...
# Najdeme hlavičku MATCH_MACRO a vložíme náš nový blok HNED ZA NÍ
...
if match:
    ...
    # Pojistka: pokud to nenajde MATCH_MACRO, vložíme to úplně na konec souboru
    app_code += "\n\n" + FULL_DETAIL_UI
